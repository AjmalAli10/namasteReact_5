const config = {
    IMG_CDN_LINK: "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/",
    RestuarantList: [
    {
    type: "restaurant",
    data: {
    ...
    cityState: "22",
    address: "KFC Restaurant, 65A, Ground Floor, Rajpur road, Dehradun, Uttarakhand, 248001",
    ...
    thirdPartyVendor: "",
    adTrackingID: "cid=5710488~p=1~eid=00000185-a08f-25b6-26f7-f2b60022017d",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5687135~p=4~eid=00000185-a08f-25b6-26f7-f2b700220400",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5669206~p=25~eid=00000185-a08f-25b6-26f7-f2be00221968",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5669288~p=7~eid=00000185-a08f-25b6-26f7-f2b800220702",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    uuid: "a56a7b6f-e90b-4699-bda7-23374049ff21",
    city: "22",
    area: "Ballupur Road",
    totalRatingsString: "100+ ratings",
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5610857~p=10~eid=00000185-a08f-25b6-26f7-f2b900220a6c",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    uuid: "52aa6635-de0f-408a-92d2-662a414bb67c",
    city: "22",
    area: "Ballupur",
    totalRatingsString: "10000+ ratings",
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5668658~p=13~eid=00000185-a08f-25b6-26f7-f2ba00220d2c",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
    ...
    id: "143944",
    name: "Laxmi Bakers",
    uuid: "6e736d64-c98f-4374-8489-ea484836bd2a",
    city: "22",
    area: "Dehradun",
    totalRatingsString: "1000+ ratings",
    ...
    uuid: "b7a7f142-be4d-4de2-b196-fcc00c7f767f",
    city: "22",
    area: "Dharampur",
    totalRatingsString: "5000+ ratings",
    ...
    thirdPartyAddress: false,
    thirdPartyVendor: "",
    adTrackingID: "cid=5668972~p=16~eid=00000185-a08f-25b6-26f7-f2bb00221076",
    badges: {
    imageBased: [ ],
    textBased: [ ],
    textExtendedBadges: [ ]
